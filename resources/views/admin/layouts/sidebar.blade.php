@php use App\Enums\AdminPermissionEnum; @endphp
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <!-- About Us -->
        <li class="menu-item {{ request()->routeIs('admin.about-us.*') ? 'active' : '' }}">
            <a href="{{ route('admin.about-us.edit') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-info-circle"></i>
                <div data-i18n="About-Us">درباره ما</div>
            </a>
        </li>
        <!-- Contact Us -->
        <li class="menu-item {{ request()->routeIs('admin.contact-us.*') ? 'active' : '' }}">
            <a href="{{ route('admin.contact-us.edit') }}" class="menu-link">
