          ...
          <svg width="26px" height="26px" viewbox="0 0 26 26" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              ...
              <g id="Login---V2" transform="translate(-667.000000, -290.000000)">
                <g id="Login" transform="translate(519.000000, 244.000000)">
                  <g id="Logo" transform="translate(148.000000, 42.000000)">
                    ...
                    <span class="app-brand-text demo h3 mb-0 fw-bold">2KhanOnline</span>
                </a>
            </div>
            <!-- /Logo -->
            <h4 class="mb-3 secondary-font">به پنل مدیریت خوش آمدید!</h4>
            <p class="mb-4">لطفا وارد حساب خود شده و مدیریت را شروع کنید</p>
            ...
            <form id="formAuthentication" class="mb-3" action="{{ route('admin.login.submit') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control text-start @error('email') is-invalid @enderror" id="email" name="email" placeholder="ایمیل خود را وارد کنید" value="{{ old('email') }}" autofocus dir="ltr" required>
                    @error('email')
                ...
                <div class="mb-3 form-password-toggle">
                    ...
                    <div class="input-group input-group-merge">
                        <input type="password" id="password" class="form-control text-start @error('password') is-invalid @enderror" name="password" placeholder="············" aria-describedby="password" dir="ltr" required>
